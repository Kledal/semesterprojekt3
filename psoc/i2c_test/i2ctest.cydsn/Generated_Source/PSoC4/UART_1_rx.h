...
#define UART_1_rx_DM_ALG_HIZ         (0x00u << UART_1_rx_DRIVE_MODE_SHIFT)
#define UART_1_rx_DM_DIG_HIZ         (0x01u << UART_1_rx_DRIVE_MODE_SHIFT)
#define UART_1_rx_DM_RES_UP          (0x02u << UART_1_rx_DRIVE_MODE_SHIFT)
#define UART_1_rx_DM_RES_DWN         (0x03u << UART_1_rx_DRIVE_MODE_SHIFT)
#define UART_1_rx_DM_OD_LO           (0x04u << UART_1_rx_DRIVE_MODE_SHIFT)
#define UART_1_rx_DM_OD_HI           (0x05u << UART_1_rx_DRIVE_MODE_SHIFT)
#define UART_1_rx_DM_STRONG          (0x06u << UART_1_rx_DRIVE_MODE_SHIFT)
#define UART_1_rx_DM_RES_UPDWN       (0x07u << UART_1_rx_DRIVE_MODE_SHIFT)
