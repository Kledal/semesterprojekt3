...
#define I2C_I2C_FSM_SL_WR          (0x12u) /* Slave write states */
#define I2C_I2C_FSM_SL_RD          (0x11u) /* Slave read  states */
#define I2C_I2C_FSM_RD             (0x01u) /* FSM slave or master read state */
...
#define I2C_CHECK_I2C_FSM_RD   (0u != (I2C_I2C_FSM_RD  & I2C_state))
