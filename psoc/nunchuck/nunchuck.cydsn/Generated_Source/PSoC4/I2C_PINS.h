...
#define I2C_MOSI_SCL_RX_PIN_MASK      ((uint32) 0x01u << I2C_MOSI_SCL_RX_PIN_INDEX)
#define I2C_MOSI_SCL_RX_WAKE_PIN_MASK ((uint32) 0x01u << I2C_MOSI_SCL_RX_WAKE_PIN_INDEX)
#define I2C_MISO_SDA_TX_PIN_MASK      ((uint32) 0x01u << I2C_MISO_SDA_TX_PIN_INDEX)
...
/* Unconfigured SCB: scl signal */
    ...
    #define I2C_WAIT_SCL_SET_HIGH  (0u == I2C_spi_mosi_i2c_scl_uart_rx_wake_Read())
    ...
    #define I2C_WAIT_SCL_SET_HIGH  (0u == I2C_spi_mosi_i2c_scl_uart_rx_Read())
...
#elif(I2C_MISO_SDA_TX_PIN)
    #define I2C_WAIT_SDA_SET_HIGH  (0u == I2C_spi_miso_i2c_sda_uart_tx_Read())
