...
#if(I2C_CY_SCBIP_V1)
    #define I2C_CY_SCBIP_V1_I2C_ONLY   (1u) /* SCB IP V1 supports only I2C */
#else
    #define I2C_CY_SCBIP_V1_I2C_ONLY   (0u) /* SCB IP V0 supports I2C, SPI, UART */
...
#define I2C_TX_FIFO_STATUS_RD_PTR_MASK ((uint32) 0x07u << I2C_TX_FIFO_STATUS_RD_PTR_POS)
#define I2C_TX_FIFO_STATUS_WR_PTR_MASK ((uint32) 0x07u << I2C_TX_FIFO_STATUS_WR_PTR_POS)
...
#define I2C_RX_FIFO_STATUS_RD_PTR_MASK ((uint32) 0x07u << I2C_RX_FIFO_STATUS_RD_PTR_POS)
#define I2C_RX_FIFO_STATUS_WR_PTR_MASK ((uint32) 0x07u << I2C_RX_FIFO_STATUS_WR_PTR_POS)
